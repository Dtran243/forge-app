...
export interface SessionLog {
  ...
  /** Logged exercise array (exercises_json.exercises column). */
  exercises: LoggedExercise[];
  /** Cardio data — null unless session_type is zone2 or intervals. */
  cardio: LoggedCardioSession | null;
  /** Mobility data — null unless a dedicated/embedded block was performed. */
  mobility: LoggedMobilitySession | null;
